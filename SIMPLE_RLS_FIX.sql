-- SIMPLE FIX: Drop ALL policies first, then recreate with correct syntax
...
-- Step 3: Now you can log in and see data
-- Test the app to verify you can see data without 500 errors

-- Step 4: If working, RE-ENABLE RLS with simpler policies
-- Run the next file: ENABLE_RLS_SIMPLE.sql
